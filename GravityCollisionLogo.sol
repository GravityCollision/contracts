...
// This is a flattened Smart Contract
// Allows 1 of 1 NFT Collections featuring a single NFT
// Mints the NFT directly to the deployer

// Based on OpenZeppelin Contracts v4.4.1 
...
// Email the security officer for any issues:  davidblythe@grav-c.io | @GravCollision
//
// Required to deploy:
...
// For baseURI, point to the metadata.json ipfs:// entry (paste in the IPFS Address)
// 
...
contract GravityCollisionLogo is ERC721, ERC721Enumerable, Ownable {
